...
namespace LeWpf.ViewModel
{
    class MainWindowViewModel : ViewModelBase
    {
        ...
        private ObservableCollection<DemoDataModel> GetDataList()
        {
            ...
            {
                new DemoDataModel{ ImgPath = "pack://application:,,,/LeWpf;component/Resource/Image/LeftMainContent/Brush_16x.png", Name = "Brush"},
                new DemoDataModel{ ImgPath = "pack://application:,,,/LeWpf;component/Resource/Image/LeftMainContent/ButtonClick_16x.png", Name = "Button"},
                new DemoDataModel{ ImgPath = "pack://application:,,,/LeWpf;component/Resource/Image/LeftMainContent/ImageStack_16x.png", Name = "ImageBlock"},
                new DemoDataModel{ ImgPath = "pack://application:,,,/LeWpf;component/Resource/Image/LeftMainContent/ImageBrowser_16x.png", Name = "ImageBrowser"},
